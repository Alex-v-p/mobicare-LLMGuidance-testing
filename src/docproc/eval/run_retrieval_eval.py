...
def main() -> None:
    ...
    if strategy == "tree_parent_child":
        ...
        # fit on parents, transform children (works for TF-IDF; for ST it doesn't matter)
    ...
    row = {
        ...
        "max_tokens": chunk_cfg.get("parent_max_tokens", chunk_cfg.get("max_tokens", "")),
        "min_tokens": chunk_cfg.get("min_tokens", ""),
    ...
    print(f"Cleaning: {profile.name} | Embedder: {row['embedder_type']} {row['embedder_model']}".strip())
